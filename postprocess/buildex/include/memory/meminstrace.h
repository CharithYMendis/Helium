...
void create_mem_layout(std::ifstream &in, std::vector<mem_info_t *> &mem_info, uint32_t version);
void create_mem_layout(std::ifstream &in, std::vector<pc_mem_region_t *> &pc_mems, uint32_t version);
